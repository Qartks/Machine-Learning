...
public class Data {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + Arrays.hashCode(featureValues);
		long temp;
		temp = Double.doubleToLongBits(labelValue);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Data other = (Data) obj;
		if (!Arrays.equals(featureValues, other.featureValues))
			return false;
		if (Double.doubleToLongBits(labelValue) != Double.doubleToLongBits(other.labelValue))
			return false;
		return true;
	}
