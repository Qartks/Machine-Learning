...
public class TreeNode {
	...
	public TreeNode(DataSet2 dataset, int depth) throws Exception {
	...
	public TreeNode(List<Feature> features,int depth,  int labelIndex, int classNum) {
		this.dataset = new DataSet2(labelIndex, features);
		this.depth = depth;
		noBranch = null;
		yesBranch = null;
		isLeaf = false;
	...
	private NodeStats createStats(DataSet2 dataset) throws Exception {
